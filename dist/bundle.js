...
const init = (window, url, options) => __awaiter(void 0, void 0, void 0, function* () {
    const vendors = yield getVendors(url);
    const cookieConsentController = new _modal__WEBPACK_IMPORTED_MODULE_1__.CookieConsentModal(window, window.document.body, vendors, Object.assign({}, options));
    if (!cookieStorage.getItem(options.cName || _modal__WEBPACK_IMPORTED_MODULE_1__.defaultOptions.cName)) {
        getVendors(url);
...
window.onload = () => {
    _models_index__WEBPACK_IMPORTED_MODULE_1__.init(window, url, { cName: 'gdpr_consent', cExpire: 1 });
};
